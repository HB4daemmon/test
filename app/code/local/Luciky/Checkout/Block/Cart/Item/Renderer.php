 ...
 */
class Luciky_Checkout_Block_Cart_Item_Renderer extends Mage_Core_Block_Template
{
    ...
    {
        return $this->getItem()->getCustomer_message();
    }
        public function getSubstitute()
    {
        return $this->getItem()->getSubstitute();
    }
