 ...
 */
class Luciky_Sales_Model_Quote_Item extends Mage_Sales_Model_Quote_Item
{
    /**
    ...
    public function setSubstitute($substitute)
    {
        ...
        $this->setData('substitute', $substitute);
        return $this;
    }
    ...
    {
        $this->setData('customer_message',$customer_message);
        return $this;
    }

    public function getCustomer_message()
    {
        return $this->getData('customer_message');
    }
...
//        }
    ...
    {
	//Mage::dispatchEvent('save_quote_item_finishd',array('quote_item'=>$this));
