    ...
    public function addAction()
    {
        ...
        if($this->getRequest()->getParam('callback')) {
            ...
            try {
                ...
                Mage::dispatchEvent('save_quote_item_finishd',array('quote'=>$this->_getQuote()));
        ...
        if ($this->getRequest()->getParam('callback')) {
            ...
            if ($id) {
                try {
                 ...
                 Mage::dispatchEvent('checkout_item_delete_after', array('quote'=>$this->_getQuote()));
        ...
        if($this->getRequest()->getParam('callback')) {
            ...
            try {
                /*if (isset($params['qty'])) {
                    ...
                    $params['qty'] = intval($filter->filter($params['qty'])) - 1;
                }*/
                $items = $cart->getItems();
        ...
        if ($this->getRequest()->getParam('callback')) {
            ...
            if ($id) {
                try {
                    ...
                    $this->_getSession()->addError($this->__('Cannot reduce the item.'));
                    Mage::logException($e);
                }
            }
            $this->loadLayout();
        ...
        if ($this->getRequest()->getParam('callback')) {
            ...
            if ($id) {
                try {
                    ...
                    $this->_getSession()->addError($this->__('Cannot add the item.'));
                    Mage::logException($e);
                }
            }
            $this->loadLayout();
